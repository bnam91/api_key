...
def get_credentials():
    ...
    if not creds or not creds.valid:
        ...
        if not creds or not creds.valid:
            ...
            auth_image_path_1 = os.path.join(script_dir, "re-auth_img", "1_ID_shin_2.png")
            auth_image_path_1 = os.path.normpath(auth_image_path_1)
            auth_image_path_2 = os.path.join(script_dir, "re-auth_img", "2_continue.png")
            auth_image_path_2 = os.path.normpath(auth_image_path_2)
            auth_image_path_3 = os.path.join(script_dir, "re-auth_img", "3.check_all.png")
            auth_image_path_3 = os.path.normpath(auth_image_path_3)
            auth_image_path_4 = os.path.join(script_dir, "re-auth_img", "4_continue_b.png")
